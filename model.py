...
class CrowdModel(Model):
    ...
    def __init__(self, width, height, N, fire_radius, social_radius, p_spreading, p_spreading_environment, p_env_knowledge_params, exits, evacuator_present = False):
        """
...
server = ModularServer(CrowdModel, [grid], "Crowd Model", {"width": width, "height": height, "N": N, "fire_radius": fire_radius, 'social_radius': social_radius, 'p_spreading': p_spreading, 'p_spreading_environment': p_spreading_environment, 'p_env_knowledge_params': p_env_knowledge_params, 'exits': exits, 'evacuator_present': True})
server.port = 9985
server.launch()
